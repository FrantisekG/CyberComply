                    ...
                    "questions": [
                        {
                            ...
                            "comment": "Např. kulturní, společenské, politické, regulační, finanční, technologické, ekonomické, přírodní a konkurenční",
                            "response": null
                        },
                    ]
                },
                    ...
                    "questions": [
                        {
                            ...
                            "comment": "Strany mohou být zainteresovány pozitivně (např. zákazník) nebo negativně (např. hacker)",
                            "response": null
                        },
                        {
                            "id": "q4.2_2",
                            "text": "Organizace má přehled o všech smlouvách, dohodách a úmluvách týkajících se funkce jejího ISMS",
                            "comment": "Sem může patřit například dohoda se zákazníkem o nakládání s informacemi po ukončení smlouvy",
                            "response": null
                        },
                        {
                            "id": "q4.2_3",
...

                {
                    ...
                    "questions": [
                        ...
                        },
                        {
                            ...
                            "comment": "Pokud o ISMS organizace rozhoduje např. její mateřská společnost, vyplňte \"ne\"",
                            "response": null
                        }
                    ]
                },
            ...
            "subsections": [
                {
                    ...
                    "questions": [
                        ...
                        },
                        {
                            ...
                            "comment": "Např. pravidelná školení o bezpečnosti informací nebo postihy při nedodržování bezpečnostních požadavků",
                            "response": null
                        }
                    ]
                },
                    ...
                    "questions": [
                        {
                            ...
                            "comment": "Informační bezpečnostní politika existuje v písemné nebo elektronické podobě",
                            "response": null
                        },
                        {
                            "id": "q5.2_2",
                        ...
                        },
                        {
                            ...
                            "comment": "Předpokládají se pouze pozitivně zainteresované strany, viz. bod 4.2",
                            "response": null
                        },
                    ]
                },
                    ...
                    "questions": [
                        {
                            ...
                            "comment": "Vyplňte \"ano\", pokud v organizaci existuje osoba s rolí CIO (Chief Information Officer) nebo rolí podobnou",
                            "response": null
                        },
                        {
                            "id": "q5.3_2",
                            "text": "Vrcholové vedení má přehled o aktuálním fungování ISMS",
                            "comment": "Vychází z komunikace vedení a CIO, \"ano\" v případě pravidelných schůzek, \"ne\" v případě nepravidelných",
                            "response": null
                        },
                    ]
                },
                    ...
                    "questions": [
                        {
                            ...
                            "comment": "Např. Delší výpadek elektrického proudu, hackerský útok, úprava zákonů",
                            "response": null
                        },
                        {
                            "id": "q6.1_2",
                            "text": "Organizace má plány pro údržbu a zlepšování ISMS",
                            "comment": "Plány mohou být v elektronické nebo písemné podobě. Předpokládá se existence krátkodobých, střednědobých i dlouhodobých plánů",
                            "response": null
                        },
                        {
                            "id": "q6.1_3",
                ...
                },
                {
                    ...
                    "questions": [
                        ...
                        },
                        {
                            ...
                            "comment": "Měřitelné např. dle standardu ISO/IEC 27004 nebo vlastních měřítek",
                            "response": null
                        },
                        {
                            "id": "q6.2_3",
                    ...
                    "questions": [
                        {
                            ...
                            "comment": "\"Ano\" v případě nadbytku zdrojů, \"ne\" v případě nedostatku zdrojů",
                            "response": null
                        },
                        {
                            "id": "q7.1_2",
                    ...
                    "questions": [
                        {
                            ...
                            "comment": "Kladen důraz na osoby pracující s PII (Personally Identifiable Information)",
                            "response": null
                        },
                        {
                            "id": "q7.3_2",
                            "text": "Lidé pracující v organizaci rozumí možným následkům při nedodržování požadavků ISMS",
                            "comment": "Následky mohou být sděleny na bezpečnostním školení nebo jinou formou",
                            "response": null
                        },
                    ],
                },
                    ...
                    "questions": [
                        {
                            ...
                            "comment": "Interní - V rámci podniku, Externí - Mimo podnik (např.zákazník)",
                            "response": null
                        },
                        {
                            "id": "q7.4_2",
                            "text": "Organizace má formální komunikační plán",
                            "comment": "Formální plán komunikace v tištěné nebo elektronické formě obsahující postupy pro interní a externí komunikaci",
                            "response": null
                        },
                    ],
                },
                    ...
                    "questions": [
                        {
                            ...
                            "comment": "Může se jednat o unikátní ID, datum, jméno zadávajícího a jiné",
                            "response": null
                        },
                        {
                            "id": "q7.5_2",
            ...
            "subsections": [
                {
                    ...
                    "questions": [
                        ...
                        },
                        {
                            ...
                            "comment": "Předpokládá se řešení následků v odpovídající době od jejich vzniku",
                            "response": null
                        },
                        {
                            "id": "q8.1_3",
                            "text": "Všechny outsourcované procesy jsou kontrolovány",
                            "comment": "Pokud v organizaci tyto procesy neexistují, zvolte \"ano",
                            "response": null
                        },
                    ],
                },
                {
                    ...
                    "questions": [
                        ...
                        },
                        {
                            ...
                            "comment": "\"Ano\" v případě pravidelné údržby, \"Částečně\" v případě nepravidelné údržby, \"Ne\" v případě žádné údržby",
                            "response": null
                        },
                    ],
                },
                ...
                },
                {
                    ...
                    "questions": [
                        ...
                        },
                        {
                            ...
                            "comment": "Auditorům bylo poskytnuto dostatečné školení příp. kurzy",
                            "response": null
                        },
                    ],
                },
                    ...
                    "questions": [
                        {
                            ...
                            "comment": "\"Ano\" v případě častého přezkoumání, \"Ne\" v případě žádného přezkoumání",
                            "response": null
                        },
                        {
                            "id": "q9.3_2",
                    ...
                    "questions": [
                        {
                            ...
                            "comment": "Dle velikosti neshody může být rozumná doba brána různě, nutno rozhoudnout z pohledu CIO",
                            "response": null
                        },
                        {
                            "id": "q10.1_2",
                            "text": "Po odstranění neshody je vytvořená dokumentace a je zajištěno, že se neshoda nebude opakovat",
                            "comment": "\"Ano\" v případě, že dokumentace je vytvářena, \"Ne\" v případě, že dokumentace není vytvářena",
                            "response": null
                        },
                    ],
                },
                    ...
                    "questions": [
                        {
                            ...
                            "comment": "Plán může obsahovat např. upgrade systému, školení zaměstnanců",
                            "response": null
                        },
                        {
                            "id": "q10.2_2",
...
function displaySection(sectionId, containerId) {
    ...
    const optionsDescription = ["Ano", "Částečně", "Ne"];
