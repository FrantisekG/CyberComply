...
function displayPercentageNISSOC2srv(chart) {
...
// .PieChartNISSOC2srv třída v HTML
document.querySelectorAll('.PieChartNISSOC2srv').forEach(function (canvas) {
    var PieChartNISSOC2srv = new Chart(canvas, {
        type: 'doughnut',
        data: {
        ...
        options: {
            ...
            animation: {
                duration: 1000,
                onComplete: function () {
                    displayPercentageNISSOC2srv(this);
