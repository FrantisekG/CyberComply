...
// Pie Chart
var ctx = document.getElementById("PieChartSOC2");
var PieChartSOC2 = new Chart(ctx, {
    type: 'doughnut',
    data: {
...
var ctxAnswers = document.getElementById("AnswersPieChartSOC2");
var AnswersPieChartSOC2 = new Chart(ctxAnswers, {
    type: 'pie',
    data: {
